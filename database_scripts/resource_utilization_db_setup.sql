...
-- Bronze layer setup and data population for the
-- resource_utilization case study.
--
-- PART 1: Schema, roles, grants, and table definitions (DDL)
-- PART 2: Bronze layer data population (DML)
--
-- Safe to run multiple times — uses IF NOT EXISTS throughout.
-- Run order: execute top to bottom in a single pass.
--
-- Prerequisites:
...
--   User: mds_user
--
-- Data range: 2026-01-13 to 2026-02-26
-- Accounts: ACC001 - ACC010
-- ============================================================


-- ============================================================
-- PART 1: DDL — Schemas, Roles, Grants, and Tables
-- ============================================================
...
-- ============================================================
-- PART 2: DML — Bronze Layer Data Population
-- ============================================================
